...
export default function App() {
  ...
  return (
    <div className="site">
      ...
      <div className="trust-band"><span><Truck size={17}/> Cash on Delivery Available</span><span><RotateCcw size={17}/> Easy Returns</span><span><ShieldCheck size={17}/> 100% Safe Payment</span></div>
