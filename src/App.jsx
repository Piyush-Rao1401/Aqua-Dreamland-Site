    ...
    <div className="site">
      ...
      <header className={`nav ${scrolled ? "scrolled" : ""}`}>
        <div className="nav-inner">
          ...
          <button className={`cart-btn ${justAdded ? "add-flash" : ""}`} onClick={openCart}><ShoppingCart size={17}/> Cart {cartCount ? `· ${cartCount}` : ""}</button>
        </div>
      </header>
