...
import {
  ...
  ShieldCheck, Truck, Leaf, Menu, ArrowUpRight
} from "lucide-react";
    ...
    <div className="site">
      <style>{`
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:${C.cream};color:${C.ink};font-family:Manrope,sans-serif}.sg{font-family:'Space Grotesk',sans-serif}button,input,textarea{font:inherit}button{cursor:pointer}.site{min-height:100vh;overflow:hidden}
        .nav{position:sticky;top:0;z-index:40;background:rgba(3,15,27,.88);backdrop-filter:blur(18px);border-bottom:1px solid rgba(164,238,238,.12);color:#fff}.nav-inner{max-width:1240px;margin:auto;padding:11px 24px;display:flex;align-items:center;gap:30px}.brand{display:flex;align-items:center;gap:11px;min-width:245px}.brand-mark{width:43px;height:43px;border-radius:13px;border:1px solid rgba(18,215,230,.6);display:grid;place-items:center;background:linear-gradient(145deg,rgba(18,215,230,.17),rgba(122,92,255,.08));box-shadow:0 0 24px rgba(18,215,230,.15)}.brand-name{font:700 22px 'Space Grotesk';letter-spacing:-.035em}.brand-sub{font-size:10px;color:#8fb2b4;letter-spacing:.14em;text-transform:uppercase;margin-top:2px}.navlinks{display:flex;align-items:center;gap:7px;flex:1;justify-content:center}.navlinks button{border:0;background:transparent;color:#c9dddd;padding:12px 13px;border-radius:10px;font-weight:600;font-size:14px;transition:.2s}.navlinks button:hover,.navlinks button.active{color:#fff;background:rgba(255,255,255,.05)}.navlinks button.active{box-shadow:inset 0 -2px ${C.aqua}}.cart-btn{border:1px solid rgba(18,215,230,.55);background:linear-gradient(135deg,#24b7cf,#2d91c5);color:#041321;border-radius:13px;padding:11px 16px;font-weight:800;display:flex;align-items:center;gap:8px;box-shadow:0 8px 28px rgba(18,215,230,.17)}.mobile-menu{display:none;background:transparent;color:#fff;border:0}
        .hero{position:relative;color:#fff;min-height:720px;display:flex;align-items:center;background:#031321 url('/betta-fish.jpg') center 42%/cover no-repeat;isolation:isolate}.hero:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(2,11,22,.97) 0%,rgba(3,17,32,.86) 33%,rgba(2,12,25,.48) 62%,rgba(2,9,18,.58) 100%);z-index:-1}.hero:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 64% 44%,rgba(81,59,212,.25),transparent 32%),linear-gradient(0deg,rgba(3,13,24,.35),transparent 25%);z-index:-1}.hero-inner{max-width:1240px;width:100%;margin:auto;padding:72px 24px 90px;display:grid;grid-template-columns:minmax(0,1.06fr) minmax(390px,.94fr);gap:42px;align-items:center}.badge{display:inline-flex;align-items:center;gap:9px;padding:8px 13px;border:1px solid rgba(18,215,230,.32);background:rgba(3,22,38,.45);border-radius:999px;backdrop-filter:blur(10px);font-size:11px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#c9f8f4}.dot{width:8px;height:8px;border-radius:50%;background:#5ff4e4;box-shadow:0 0 14px #5ff4e4}.hero-kicker{color:#a9d7d7;font-weight:700;font-size:15px;margin:19px 0 12px}.hero h1{font:700 clamp(48px,5.25vw,76px)/.98 'Space Grotesk';letter-spacing:-.055em;margin:0;max-width:770px}.hero h1 .accent{color:#16dbe7}.hero p{max-width:600px;color:#c9dcdd;font-size:17px;line-height:1.72;margin:23px 0 0}.hero-ctas{display:flex;gap:12px;flex-wrap:wrap;margin-top:29px}.primary,.secondary{border-radius:13px;padding:14px 20px;font-weight:800;font-size:15px;display:inline-flex;align-items:center;gap:7px;transition:.22s}.primary{border:1px solid rgba(255,255,255,.1);background:linear-gradient(135deg,#18d8e5,#3a8eff);color:#041321;box-shadow:0 12px 34px rgba(18,215,230,.23)}.secondary{border:1px solid rgba(201,243,238,.3);background:rgba(3,16,31,.3);color:#fff;backdrop-filter:blur(8px)}.primary:hover,.secondary:hover{transform:translateY(-3px)}.stats{display:flex;gap:0;flex-wrap:wrap;margin-top:35px}.stat{padding:0 24px 0 0;margin-right:24px;border-right:1px solid rgba(201,243,238,.2);color:#9bb8ba;font-size:12px}.stat:last-child{border:0}.stat strong{display:block;color:#fff;font:700 16px 'Space Grotesk';margin-bottom:3px}.hero-cards{display:grid;grid-template-columns:1fr 1fr;gap:13px}.hero-card{position:relative;min-height:195px;padding:17px;border-radius:18px;overflow:hidden;border:1px solid rgba(173,239,240,.27);background:linear-gradient(145deg,rgba(4,24,42,.68),rgba(8,20,39,.4));backdrop-filter:blur(13px);box-shadow:0 18px 55px rgba(0,0,0,.2);transition:.25s}.hero-card:hover{transform:translateY(-5px);border-color:rgba(18,215,230,.62)}.hero-card .hc-top{display:flex;justify-content:space-between;align-items:flex-start}.hc-icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(18,215,230,.12);color:#baf8f1;border:1px solid rgba(18,215,230,.17)}.hero-card .hc-arrow{width:29px;height:29px;border-radius:50%;display:grid;place-items:center;background:rgba(18,215,230,.12);color:#8ceff2}.hero-card h3{font:700 17px 'Space Grotesk';margin:17px 0 5px}.hero-card p{font-size:12.5px;line-height:1.48;color:#aac3c4;margin:0;max-width:205px}.hero-card .mini-image{position:absolute;right:-10px;bottom:-15px;opacity:.9;transform:scale(.8)}
        .wave-bottom{position:absolute;bottom:-1px;left:0;width:100%;height:52px;z-index:3}.wave-bottom path{fill:${C.cream}}
