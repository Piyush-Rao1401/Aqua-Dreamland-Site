    ...
    <div className="site">
      <style>{`
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:${C.cream};color:${C.ink};font-family:Manrope,sans-serif}.sg{font-family:'Space Grotesk',sans-serif}button,input,textarea{font:inherit}button{cursor:pointer}.site{min-height:100vh;overflow:hidden}
        ...
        .hero-card:nth-child(1) .mini-image .product-art:after{background-image:url('/aquarium-card.jpg')}
        .hero-card:nth-child(2) .mini-image .product-art:after{background-image:url('/soft-toys-card.jpg')}
        .hero-card:nth-child(3) .mini-image .product-art:after{background-image:url('/pots-card.jpg')}
        .hero-card:nth-child(4) .mini-image .product-art:after{background-image:url('/resin-card.jpg')}
