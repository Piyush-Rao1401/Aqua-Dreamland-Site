        ...
        <section id="home" className="hero">
          ...
          <div className="hero-inner">
            <div className="hero-text">
              ...
              <a className="social-proof" href={GOOGLE_REVIEWS_URL} target="_blank" rel="noopener noreferrer"><div className="sp-stars">{[...Array(5)].map((_,i) => <Star key={i} size={15} fill="#f5b400" color="#f5b400"/>)}</div><span><strong>5.0</strong> rating · <strong>118+</strong> happy customers on Google</span></a>
