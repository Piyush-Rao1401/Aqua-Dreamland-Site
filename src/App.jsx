    ...
    <div className="site">
      <style>{`
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:${C.cream};color:${C.ink};font-family:Manrope,sans-serif}.sg{font-family:'Space Grotesk',sans-serif}button,input,textarea{font:inherit}button{cursor:pointer}.site{min-height:100vh;overflow:hidden}
        .nav{position:sticky;top:0;z-index:40;background:rgba(3,15,27,.7);backdrop-filter:blur(10px);border-bottom:1px solid rgba(164,238,238,.08);color:#fff;transition:background .3s ease,backdrop-filter .3s ease,border-color .3s ease,box-shadow .3s ease}.nav.scrolled{background:rgba(3,15,27,.93);backdrop-filter:blur(20px);border-bottom-color:rgba(164,238,238,.16);box-shadow:0 12px 34px rgba(0,0,0,.22)}.nav-inner{max-width:1620px;margin:auto;padding:11px 24px;display:flex;align-items:center;gap:30px}.brand{display:flex;align-items:center;gap:11px;min-width:245px}.brand-mark{width:52px;height:52px;border-radius:15px;border:1.5px solid rgba(255,79,216,.65);display:grid;place-items:center;background:linear-gradient(145deg,rgba(255,79,216,.18),rgba(122,92,255,.1));box-shadow:0 0 24px rgba(255,79,216,.3);transition:box-shadow .3s ease,transform .3s ease;position:relative;overflow:hidden}.brand-mark:before{content:"";position:absolute;inset:-3px;border-radius:17px;background:linear-gradient(135deg,${C.pink},${C.purple2},${C.aqua});z-index:-1;opacity:.55;animation:mark-pulse 2.8s ease-in-out infinite}.brand:hover .brand-mark{box-shadow:0 0 40px rgba(255,79,216,.55),0 0 16px rgba(34,197,139,.35);transform:scale(1.08)}
        @keyframes mark-pulse{0%,100%{opacity:.35;filter:blur(2px)}50%{opacity:.75;filter:blur(4px)}}.brand-name{font:700 22px 'Space Grotesk';letter-spacing:-.035em}.brand-sub{font-size:10px;color:#8fb2b4;letter-spacing:.14em;text-transform:uppercase;margin-top:2px}.navlinks{display:flex;align-items:center;gap:7px;flex:1;justify-content:center}.navlinks button{border:0;background:transparent;color:#c9dddd;padding:12px 13px;border-radius:10px;font-weight:600;font-size:14px;transition:.2s;position:relative}.navlinks button:hover,.navlinks button.active{color:#fff;background:rgba(255,255,255,.05)}.navlinks button:after{content:"";position:absolute;left:13px;right:13px;bottom:6px;height:2px;background:linear-gradient(90deg,${C.pink},${C.purple2});border-radius:2px;transform:scaleX(0);transform-origin:center;transition:transform .3s ease}.navlinks button:hover:after{transform:scaleX(.5)}.navlinks button.active:after{transform:scaleX(1)}.cart-btn{border:1px solid rgba(255,79,216,.5);background:linear-gradient(135deg,#e83fc0,#b14aff);color:#fff;border-radius:13px;padding:11px 16px;font-weight:800;display:flex;align-items:center;gap:8px;box-shadow:0 8px 28px rgba(255,79,216,.22);position:relative}.cart-badge{position:absolute;top:-7px;right:-7px;min-width:19px;height:19px;padding:0 4px;border-radius:999px;background:${C.green};color:#fff;font-size:10.5px;font-weight:800;display:grid;place-items:center;border:2px solid ${C.navy}}
        ...
        .hero{position:relative;color:#fff;min-height:calc(100vh - 76px);;display:flex;align-items:center;background:#031321;isolation:isolate}.hero-bg{position:absolute;inset:0;background:url('/shutterstock-1915386694-huge-licensed-scaled.jpg') center 38%/cover no-repeat;filter:saturate(1.12) contrast(1.03);z-index:-2}.hero:before{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(2,11,22,.97) 0%,rgba(3,17,32,.82) 33%,rgba(2,12,25,.4) 62%,rgba(2,9,18,.52) 100%);z-index:-1}.hero:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 66% 30%,rgba(120,70,255,.32),transparent 36%),radial-gradient(circle at 78% 70%,rgba(255,60,210,.22),transparent 34%),radial-gradient(circle at 30% 80%,rgba(18,215,230,.16),transparent 30%);z-index:-1}.hero-inner{max-width:1620px;width:100%;margin:auto;padding:58px 34px 74px;display:grid;grid-template-columns:minmax(0,1.03fr) minmax(520px,.97fr);gap:48px;align-items:center}.hero-logo{width:210px;margin-bottom:22px;position:relative;isolation:isolate;border-radius:16px;overflow:hidden}.hero-logo img{width:100%;display:block;position:relative;z-index:1;border-radius:16px;filter:drop-shadow(0 10px 30px rgba(0,0,0,.5))}.hero-logo:before{content:"";position:absolute;inset:8px;border-radius:50%;background:radial-gradient(circle,rgba(255,79,216,.45),transparent 68%);filter:blur(18px);opacity:.85;animation:logo-glow 3.2s ease-in-out infinite;z-index:0}
        @keyframes logo-glow{0%,100%{opacity:.55;transform:scale(.95)}50%{opacity:1;transform:scale(1.08)}}
        @media(max-width:700px){.hero-logo{width:150px;margin-bottom:14px}}
      ...
      <header className={`nav ${scrolled ? "scrolled" : ""}`}>
        <div className="nav-inner">
          <div className="brand">
            <div className="brand-mark"><img src="/logo-icon.png" alt="Aqua Dreamland logo" style={{width:"100%",height:"100%",objectFit:"cover",borderRadius:13}}/></div>
      ...
      <main>
        <section id="home" className="hero">
          ...
          <div className="hero-inner">
            <div>
              <div className="hero-logo"><img src="/logo-full-trimmed.png" alt="Aqua Dreamland"/></div>
