    ...
    <div className="site">
      <style>{`
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:${C.cream};color:${C.ink};font-family:Manrope,sans-serif}.sg{font-family:'Space Grotesk',sans-serif}button,input,textarea{font:inherit}button{cursor:pointer}.site{min-height:100vh;overflow:hidden}
        .nav{position:sticky;top:0;z-index:40;background:rgba(3,15,27,.7);backdrop-filter:blur(10px);border-bottom:1px solid rgba(164,238,238,.08);color:#fff;transition:background .3s ease,backdrop-filter .3s ease,border-color .3s ease,box-shadow .3s ease}.nav.scrolled{background:rgba(3,15,27,.93);backdrop-filter:blur(20px);border-bottom-color:rgba(164,238,238,.16);box-shadow:0 12px 34px rgba(0,0,0,.22)}.nav-inner{max-width:1620px;margin:auto;padding:11px 24px;display:flex;align-items:center;gap:30px}.brand{display:flex;align-items:center;gap:11px;min-width:245px}
        .brand-name{font:700 22px 'Space Grotesk';letter-spacing:-.035em}.brand-accent{background:linear-gradient(90deg,${C.pink},${C.purple2},${C.aqua});-webkit-background-clip:text;background-clip:text;color:transparent}.brand-sub{font-size:10px;color:#8fb2b4;letter-spacing:.14em;text-transform:uppercase;margin-top:2px}.navlinks{display:flex;align-items:center;gap:7px;flex:1;justify-content:center}.navlinks button{border:0;background:transparent;color:#c9dddd;padding:12px 13px;border-radius:10px;font-weight:600;font-size:14px;transition:.2s;position:relative}.navlinks button:hover,.navlinks button.active{color:#fff;background:rgba(255,255,255,.05)}.navlinks button:after{content:"";position:absolute;left:13px;right:13px;bottom:6px;height:2px;background:linear-gradient(90deg,${C.pink},${C.purple2});border-radius:2px;transform:scaleX(0);transform-origin:center;transition:transform .3s ease}.navlinks button:hover:after{transform:scaleX(.5)}.navlinks button.active:after{transform:scaleX(1)}.cart-btn{border:1px solid rgba(255,79,216,.5);background:linear-gradient(135deg,#e83fc0,#b14aff);color:#fff;border-radius:13px;padding:11px 16px;font-weight:800;display:flex;align-items:center;gap:8px;box-shadow:0 8px 28px rgba(255,79,216,.22);position:relative}.cart-badge{position:absolute;top:-7px;right:-7px;min-width:19px;height:19px;padding:0 4px;border-radius:999px;background:${C.green};color:#fff;font-size:10.5px;font-weight:800;display:grid;place-items:center;border:2px solid ${C.navy}}
        ...
        .hero-card .mini-image .product-art:after{content:"";position:absolute;right:0;bottom:0;width:180px;height:165px;border-radius:14px;background-size:contain;background-repeat:no-repeat;background-position:center;opacity:1}
        .hero-card:nth-child(1) .mini-image .product-art:after{background-image:url('/aquarium-card-final.jpg')}
        .hero-card:nth-child(2) .mini-image .product-art:after{background-image:url('/soft-toy-original.jpeg')}
        ...
        .hero-card:nth-child(4) .mini-image .product-art:after{background-image:url('/resin-card-crop.jpg')}
